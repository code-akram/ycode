...
- host discovery models used while assembling built-in tool sets
- host adapters such as schema sanitization, dynamic conversion, code-mode
...
- dynamic-tool adaptation into Responses API shapes
