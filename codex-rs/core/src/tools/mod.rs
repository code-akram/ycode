...
// Log preview limits: keep diagnostic events smaller than model budgets.
pub(crate) const LOG_PREVIEW_MAX_BYTES: usize = 2 * 1024; // 2 KiB
pub(crate) const LOG_PREVIEW_MAX_LINES: usize = 64; // lines
pub(crate) const LOG_PREVIEW_TRUNCATION_NOTICE: &str = "[... log preview truncated ...]";
