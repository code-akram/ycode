...
//!
//! The history is stored at `~/.ycode/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.ycode`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.ycode/history.jsonl` and ensure the parent directory exists.
