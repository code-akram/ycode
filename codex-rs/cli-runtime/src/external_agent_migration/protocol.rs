...
use codex_cli_protocol::CommandMigration;
...
use codex_cli_protocol::ExternalAgentConfigImportHistory;
use codex_cli_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use codex_cli_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
use codex_cli_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
use codex_cli_protocol::ExternalAgentConfigMigrationItem;
use codex_cli_protocol::ExternalAgentConfigMigrationItemType;
use codex_cli_protocol::HookMigration;
use codex_cli_protocol::JSONRPCErrorError;
use codex_cli_protocol::MigrationDetails;
use codex_cli_protocol::PluginsMigration;
use codex_cli_protocol::SkillMigration;
use codex_cli_protocol::SubagentMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| codex_cli_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
