...
pub(super) async fn unload_thread_without_subscribers(
    ...
    // Any pending cli-runtime -> client requests for this thread can no longer be
...
fn merge_active_turn_into_page(
    page: &mut codex_cli_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &codex_cli_protocol::ThreadResumeInitialTurnsPageParams,
) {
