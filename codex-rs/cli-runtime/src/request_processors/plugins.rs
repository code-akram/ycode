...
use codex_cli_protocol::PluginSharePrincipalRole;
use codex_cli_protocol::PluginShareTargetRole;
...
impl PluginRequestProcessor {
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<codex_cli_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| codex_cli_protocol::MarketplaceLoadErrorInfo {
            ...
            Ok(marketplace_path) => {
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| codex_cli_protocol::PluginHookSummary {
                            key: hook.key,
    ...
    async fn remote_plugin_install_response(
        ...
        let _install_result = codex_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
