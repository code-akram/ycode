...
use codex_cli_protocol::build_item_from_guardian_event;
use codex_cli_protocol::guardian_auto_approval_review_notification;
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: codex_cli_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            codex_cli_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use codex_cli_protocol::AutoReviewDecisionSource;
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(codex_cli_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(codex_cli_protocol::GuardianUserAuthorization::Low)
                );
