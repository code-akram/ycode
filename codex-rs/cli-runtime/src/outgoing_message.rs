...
pub(crate) use crate::transport::ConnectionId;
pub(crate) use crate::transport::OutgoingError;
pub(crate) use crate::transport::OutgoingMessage;
pub(crate) use crate::transport::OutgoingResponse;
pub(crate) use crate::transport::QueuedOutgoingMessage;
...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_server_notification_to_connections(
        ...
        tracing::trace!(
            ...
            "cli-runtime event: {notification}"
        );
    ...
    pub(crate) async fn send_server_notification_to_connection_and_wait(
        ...
        tracing::trace!("cli-runtime event: {notification}");
        let outgoing_message = timestamped_server_notification(notification);
...
fn timestamped_server_notification(notification: ServerNotification) -> OutgoingMessage {
    OutgoingMessage::CliRuntimeNotification(ServerNotificationEnvelope {
        notification,
...
mod tests {
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        outgoing
            .send_response(
                request_id.clone(),
                ClientResponsePayload::ThreadArchive(codex_cli_protocol::ThreadArchiveResponse {}),
            )
            .await;
    ...
    async fn send_response_clears_registered_request_context() {
        ...
        outgoing
            .register_request_context(RequestContext::new(
                request_id.clone(),
                tracing::info_span!("cli_runtime.request", rpc.method = "thread/start"),
                /*parent_trace*/ None,
            ))
            .await;
    ...
    async fn send_server_notification_to_connections_reuses_timestamp() {
        ...
        .map(|envelope| match envelope {
            OutgoingEnvelope::ToConnection {
                message: OutgoingMessage::CliRuntimeNotification(envelope),
                ..
    ...
    async fn send_server_notification_to_connection_and_wait_tracks_write_completion() {
        ...
        let OutgoingMessage::CliRuntimeNotification(envelope) = message else {
            panic!("expected cli-runtime notification");
        };
        assert!(
            envelope
                .emitted_at_ms
    ...
    async fn connection_closed_clears_registered_request_contexts() {
        ...
        outgoing
            .register_request_context(RequestContext::new(
                ...
                tracing::info_span!("cli_runtime.request", rpc.method = "turn/interrupt"),
                /*parent_trace*/ None,
            ))
            .await;
        outgoing
            .register_request_context(RequestContext::new(
                ...
                tracing::info_span!("cli_runtime.request", rpc.method = "turn/start"),
                /*parent_trace*/ None,
            ))
            .await;
