//! Paths resolved using the cli-runtime host's platform rules.

use std::fmt;

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct CliRuntimePath(String);

impl CliRuntimePath {
    pub fn from_cli_runtime(path: impl Into<String>) -> Self {
        Self(path.into())
    }
...
impl fmt::Display for CliRuntimePath {
